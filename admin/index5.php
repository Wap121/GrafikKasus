        ...
        <div class="row">
            ...
            <div class="table-responsive" data-aos="fade-up">
              <table id="Tahun" class="table table-bordered table-striped" border="1" align="center" width="95%">
                ...
                $query1="SELECT * FROM galeri";
                $nobaris = $row + 1;
                $result1=mysqli_query($conn, $query1);
                if ($result1->num_rows > 0){
                  while ($row1 = $result1-> fetch_assoc()){
                  echo "<tr>";
                  echo '<td><img class="d-block w-100" width= "50%" height="auto" src="data:image/jpeg;base64,'.base64_encode($row1['foto'] ).'" /></a></td>';
                  echo "<td><a href='isigaleri.php?id=".$row1['id']."'>Edit</a></td>";
                  echo "<td><a href='../php/deletegaleri.php?id=".$row1['id']."'>Hapus</a></td>";
                  echo "</tr>";
                  $nobaris ++;
                  }
                }
