    ...
    <section id="portfolio" class="portfolio section-bg">
      <div class="container">
        ...
        <?php
         ...
         $noAdm = $_GET['id'];
         $query="SELECT * FROM user WHERE id='$noAdm'";
          ...
          <div class="row">
            <div class="col-lg-8 mx-auto">
              <div class="modal-body">
                <form action="../php/updateadmin.php?id=<?php echo $noAdm ?>" method="POST">
                  <div class="form-group">
                    <br/>
                    <label for="username" font-weight="bold">Username</label>
                    <input type="text" style="text-align:center;" name="username" class="form-control" autofocus="on" value="<?php echo $Username ?>"><br/>
                  </div>
                  <div class="form-group">
                    <br/>
                    <label for="password" font-weight="bold">Password</label>
                    <input type="text" style="text-align:center;" name="password" class="form-control" autofocus="on" value="<?php echo $Password ?>"><br/>
                  </div>
