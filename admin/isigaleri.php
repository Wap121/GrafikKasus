    ...
    <section id="portfolio" class="portfolio section-bg">
      <div class="container">
        ...
        <?php
         ...
         $noGal = $_GET['id'];
         $query="SELECT * FROM galeri WHERE id='$noGal'";
          ...
          <div class="row">
            <div class="col-lg-8 mx-auto">
              <div class="modal-body">
                <form action="../php/updategaleri.php?id=<?php echo $noGal ?>" method="POST" enctype="multipart/form-data">
                  <div class="form-group">
                    <label for="foto">Masukkan Foto Grafik</label><br/>
