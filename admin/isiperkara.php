    ...
    <section id="portfolio" class="portfolio section-bg">
      <div class="container">
        ...
        <?php
         ...
         $noPerkara = $_GET['idperkara'];
         $query="SELECT * FROM data_perkara WHERE idperkara='$noPerkara'";
         $result=mysqli_query($conn, $query);
         if ($result->num_rows > 0){
           while ($row = $result-> fetch_assoc()){
            $Perkara = $row['nama_perkara'];
           }
         } else {
             $Perkara = '';
         }
          ...
          <div class="row">
            <div class="col-lg-8 mx-auto">
              <div class="modal-body">
                <form action="../php/updatepidum1.php?idperkara=<?php echo $noPerkara ?>" method="POST">
                  <div class="form-group">
                    <br/>
                    <label for="perkara" font-weight="bold">Perkara</label>
                    <input type="text" style="text-align:center;" name="perkara" class="form-control" autofocus="on" value="<?php echo $Perkara ?>"><br/>
                  </div>
