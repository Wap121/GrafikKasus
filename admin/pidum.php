          ...
          <div class="row">
            <div class="col-lg-8 mx-auto">
              <div class="modal-body">
                <form action="../php/daftarpidum.php" method="POST">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" style="text-align:center;" name="eoh" class="form-control" autofocus="on"><br/>
                  </div>
                  <div class="form-group">
                    <label for="eku">EKU</label>
                    <input type="text" style="text-align:center;" name="eku" class="form-control"><br/>
                  </div>
                  <div class="form-group">
                    <label for="enz">ENZ</label>
                    <input type="text" style="text-align:center;" name="enz" class="form-control"><br/>
                  </div>
