    ...
    <section id="portfolio" class="portfolio section-bg">
      <div class="container">
        ...
        <?php
         ...
         $noBul = $_GET['idbulan'];
         $query="SELECT * FROM data_bulan WHERE idbulan='$noBul'";
         $result=mysqli_query($conn, $query);
         if ($result->num_rows > 0){
           while ($row = $result-> fetch_assoc()){
            $Bulan = $row['nama_bulan'];
           }
         } else {
             $Bulan = '';
         }
          ...
          <div class="row">
            <div class="col-lg-8 mx-auto">
              <div class="modal-body">
                <form action="../php/updatebulan.php?idbulan=<?php echo $noBul ?>" method="POST">
                  <div class="form-group">
                    <br/>
                    <label for="bulan" font-weight="bold">Bulan</label>
                    <input type="text" style="text-align:center;" name="bulan" class="form-control" autofocus="on" value="<?php echo $Bulan ?>"><br/>
                  </div>
