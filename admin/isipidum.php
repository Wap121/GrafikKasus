          ...
          <div class="row">
            <div class="col-lg-8 mx-auto">
              <div class="modal-body">
                <form action="../php/updatepidum.php?idpidum=<?php echo $noPidum ?>" method="POST">
                  ...
                  <div class="form-group">
                    <label for="Pasal">Pilih Pasal</label><br/>
                      <select name="Perkara1">
                        <option value="<?php echo $Perkara?>"><?php echo $Perkara1 ?></option>
                          <?php
                  ...
                  <div class="form-group">
                    <br/>
                    <label for="eoh" font-weight="bold">EOH</label>
                    <input type="text" style="text-align:center;" name="eoh" class="form-control" autofocus="on" value="<?php echo $EOH ?>"><br/>
                  </div>
                  <div class="form-group">
                    <label for="eku">EKU</label>
                    <input type="text" style="text-align:center;" name="eku" class="form-control" value="<?php echo $EKU ?>"><br/>
                  </div>
                  <div class="form-group">
                    <label for="enz">ENZ</label>
                    <input type="text" style="text-align:center;" name="enz" class="form-control" value="<?php echo $ENZ ?>"><br/>
                  </div>
