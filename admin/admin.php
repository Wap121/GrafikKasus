      ...
      <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-12" data-aos="fade-up">
              <h3 class="resume-title"><center>Data Admin</center></h3>
            </div>
            <div class="table-responsive" data-aos="fade-up">
              <table id="Tahun" class="table table-bordered table-striped" border="1" align="center" width="95%">
                ...
                <tbody>
                <?php
                $sql = "SELECT COUNT(*) AS jumlahbaris FROM user";
                ...
                if ($result1->num_rows > 0){
                  ...
                  echo "<td><a href='isiadmin.php?id=".$row1['id']."'>Edit</a></td>";
                  echo "<td><a href='../php/deleteadmin.php?id=".$row1['id']."'>Hapus</a></td>";
                  echo "</tr>";
                  $nobaris ++;
                  }
                }
