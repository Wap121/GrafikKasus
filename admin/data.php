          ...
          <div class="row">
            <div class="col-lg-8 mx-auto">
              <div class="modal-body">
                <form action="../php/daftarkasus.php" method="POST">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" style="text-align:center;" name="sd" class="form-control" autofocus="on"><br/>
                  </div>
                  <div class="form-group">
                    <label for="smp">SMP</label>
                    <input type="text" style="text-align:center;" name="smp" class="form-control"><br/>
                  </div>
                  <div class="form-group">
                    <label for="sma">SMA</label>
                    <input type="text" style="text-align:center;" name="sma" class="form-control"><br/>
                  </div>
                  <div class="form-group">
                    <label for="d3">D3/S1</label>
                    <input type="text" style="text-align:center;" name="d3" class="form-control"><br/>
                  </div>
                  <div class="form-group">
                    <label for="umur1">Pelaku berusia kurang dari 18 tahun</label>
                    <input type="text" style="text-align:center;" name="umur1" class="form-control"><br/>
                  </div>
                  <div class="form-group">
                    <label for="umur2">Pelaku berusia antara 18-25 tahun</label>
                    <input type="text" style="text-align:center;" name="umur2" class="form-control"><br/>
                  </div>
                  <div class="form-group">
                    <label for="umur3">Pelaku berusia antara 25-50 tahun</label>
                    <input type="text" style="text-align:center;" name="umur3" class="form-control"><br/>
                  </div>
                  <div class="form-group">
                    <label for="umur4">Pelaku berusia lebih dari 50 tahun</label>
                    <input type="text" style="text-align:center;" name="umur4" class="form-control"><br/>
                  </div>
                  <div class="form-group">
                    <label for="lelaki">Laki-laki</label>
                    <input type="text" style="text-align:center;" name="lelaki" class="form-control"><br/>
                  </div>
                  <div class="form-group">
                    <label for="perempuan">Perempuan</label>
                    <input type="text" style="text-align:center;" name="perempuan" class="form-control"><br/>
                  </div>
