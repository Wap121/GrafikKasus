          ...
          <div class="row">
            <div class="col-lg-8 mx-auto">
              <div class="modal-body">
                <form action="../php/tambahtahun.php" method="POST">
                  <div class="form-group">
                    <br/>
                    <label for="tahun" font-weight="bold">Tahun</label>
                    <input type="text" style="text-align:center;" name="tahun" class="form-control" autofocus="on"><br/>
                  </div>
                    <button type="submit" class="btn btn-primary btn-block" name="save">Save</button><br/>
                </form>
                <form action="../php/tambahpasal.php" method="POST">
                    <div class="form-group" >
                        <label for="pasal">Pasal</label>
                        <input type="text" style="text-align:center;" name="pasal" class="form-control"><br/>
                    </div>
                    <button type="submit" class="btn btn-primary btn-block" name="save">Save</button><br/>
                </form>
                <form action="../php/tambahperkara.php" method="POST">
                    <div class="form-group" >
                        <label for="perkara">Perkara</label>
                        <input type="text" style="text-align:center;" name="perkara" class="form-control"><br/>
                    </div>
                    <button type="submit" class="btn btn-primary btn-block" name="save">Save</button><br/>
                </form>
              </div>
