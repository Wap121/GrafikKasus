    ...
    <section id="portfolio" class="portfolio section-bg">
      <div class="container">
        ...
        <?php
         ...
         $noTah = $_GET['idtahun'];
         $query="SELECT * FROM data_tahun WHERE idtahun='$noTah'";
          ...
          <div class="row">
            <div class="col-lg-8 mx-auto">
              <div class="modal-body">
                <form action="../php/updatetahun.php?idtahun=<?php echo $noTah ?>" method="POST">
                  <div class="form-group">
                    <br/>
                    <label for="tahun" font-weight="bold">Tahun</label>
                    <input type="text" style="text-align:center;" name="tahun" class="form-control" autofocus="on" value="<?php echo $Tahun ?>"><br/>
                  </div>
