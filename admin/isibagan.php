    ...
    <section id="portfolio" class="portfolio section-bg">
      <div class="container">
        ...
        <?php
         ...
         $noBagan = $_GET['id'];
         $query="SELECT * FROM bagan WHERE id='$noBagan'";
         $result=mysqli_query($conn, $query);
         if ($result->num_rows > 0){
           while ($row = $result-> fetch_assoc()){
            $Bagan = ''.base64_encode($row['bagan'] ).'';
           }
         } else {
             $Bagan = '';
         }
          ...
          <div class="row">
            <div class="col-lg-8 mx-auto">
              <div class="modal-body">
                <form action="../php/updatebagan.php?id=<?php echo $noBagan ?>" method="POST" enctype="multipart/form-data">
                  <div class="form-group">
                    <label for="foto">Masukkan Foto Bagan</label><br/>
                    <img src="data:image/jpg;charset=utf8;base64,<?php echo $Bagan ?>" height="200" width="350" class="img-thumnail" />
